...
import br.udesc.ceavi.trabalhoFinalProgII.View.Frame.Secundarios.Remover.removerFornecedor;
import br.udesc.ceavi.trabalhoFinalProgII.View.Frame.Secundarios.Remover.removerTipo;
 ...
 */
public class GerarVFornecedor  extends Gerar{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (frame == null && frame2 == null) {
            ...
            frame = new removerFornecedor("Visualizar Fornecedor", tamanho);
            ...
            frame2 = new removerFornecedor("Visualizar Fornecedor", tamanho);
