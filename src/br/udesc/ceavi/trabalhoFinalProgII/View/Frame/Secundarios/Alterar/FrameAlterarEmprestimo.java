...
public class FrameAlterarEmprestimo extends FrameAlterar {
    ...
    private Label lbItemF;
    private Label lbRequisitanteF;
    ...
    private void initCom() {
        ...
        lbItemF = new Label(null);
        if (emprestimo.getItem() != null) {
            lbItemF.setText(emprestimo.getItem().getNome());
        }
        lbItemF.setSize(btTamanho);
        
        lbRequisitanteF = new Label(null);
        if (emprestimo.getRequisitante() != null) {
            lbRequisitanteF.setText(emprestimo.getRequisitante().getNome());
        }
